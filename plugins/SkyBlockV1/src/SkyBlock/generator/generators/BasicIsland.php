        ...
        if ($chunkX % 20 == 0 && $chunkZ % 20 == 0) {
            for ($x = 0; $x < 16; $x++) {
                for ($z = 0; $z < 16; $z++) {
					...
					$chunk->setBlock(8, 29, 8, Block::BEDROCK);
					...
					$chunk->setBlock(9, 36, 6, Block::TORCH);
                    ...
                    $chunk->setBlock(7, 34, 6, Block::GLOWSTONE_BLOCK);
                ...
                Tree::growTree($this->level, $chunkX * 160 + 80, 60, $chunkZ * 1 + 0, $this->random, 0);
            }
            $chunk->setX($chunkX);
            $chunk->setZ($chunkZ);
